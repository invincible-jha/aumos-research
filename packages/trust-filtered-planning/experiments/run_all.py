...
"""
run_all.py — Run all trust-filtered-planning experiments and save results.
...
def main() -> None:
    ...
    print("=" * 62)
    print("trust-filtered-planning — Run All Experiments")
    print("SIMULATION ONLY — forward BFS, synthetic data, seed=42")
    print("=" * 62)

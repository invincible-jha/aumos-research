...
"""
run_all.py — Run all delegation-trust-model experiments and save results.
...
def main() -> None:
    ...
    print("=" * 62)
    print("delegation-trust-model — Run All Experiments")
    ...
    print("SIMULATION ONLY — all results are synthetic, seed=42.")
    print(f"{'=' * 62}")
